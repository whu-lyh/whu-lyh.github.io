...
# 🔥 News
- 2026.03: 🎉🎉🎉 One paper (AGI2P) is accepted by ISPRS J. (SCI1-TOP, IF:  12.7). Congratulations to Yandi.
...
+ ``ISPRS J 2026`` [AGI2P: Benchmarking Aerial–Ground Image-to-Point Cloud Localization with a Large-Scale Dataset](https://arxiv.org/abs/2509.07362). Yandi Yang, [Jianping Li](https://kafeiyin00.github.io/),  [Youqi Liao](https://martin-liao.github.io/), **Yuhao Li**, Ruizhe Niu, Yizhe Zhang,  [Zhen Dong](https://dongzhenwhu.github.io/), [Bisheng Yang](https://3s.whu.edu.cn/ybs/index.htm), [Naser El-Sheimy](https://profiles.ucalgary.ca/naser-el-sheimy).  (SCI1-TOP, IF:12.7).   | [Arxiv](https://arxiv.org/abs/2509.07362). 
