...
+ ``ISPRS J 2026`` [AGI2P: Benchmarking Aerial–Ground Image-to-Point Cloud Localization with a Large-Scale Dataset](https://arxiv.org/abs/2509.07362). Yandi Yang, [Youqi Liao](https://martin-liao.github.io/), [Jianping Li](https://kafeiyin00.github.io/), **Yuhao Li**, Ruizhe Niu, Yizhe Zhang,  [Zhen Dong](https://dongzhenwhu.github.io/), [Bisheng Yang](https://3s.whu.edu.cn/ybs/index.htm), [Naser El-Sheimy](https://profiles.ucalgary.ca/naser-el-sheimy). | [Arxiv](https://arxiv.org/abs/2509.07362). 
